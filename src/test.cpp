...
void simulation1(int argc, char **argv)
{
    ...
    {
        MxMfilenames.push_back(dat_folder+base_filename + std::to_string(i + 1) + "x" + std::to_string(i + 1) + "beta" + std::to_string(input_beta) + ".txt");
        MxNfilenames.push_back(dat_folder+base_filename + std::to_string(i + 1) + "x" + std::to_string(i) + "beta" + std::to_string(input_beta) + ".txt");
